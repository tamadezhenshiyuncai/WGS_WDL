...
task report {
    ...
    command <<<
        ...
        ~{tools_dir}/wgs_database/pipeline_anno/xgentic_Annotation/anno2xlsx/tier1tags/tier1tags \
            ...
            -columns ~{tools_dir}/wgs_database/pipeline_anno/xgentic_Annotation/anno2xlsx/template/wgs.tier1tag.title.txt && \
